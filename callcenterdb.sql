...
--
-- Host: localhost
-- Generation Time: Oct 18, 2018 at 08:35 AM
...
(178, NULL, 0, 'Complaint Process', 'main', 'main/', 3, 'fa fa-comment', '', '_parent', 1, '2017-01-09 10:48:01', '2018-10-04 11:06:09', NULL),
(182, NULL, 178, 'Damage List', 'damage', 'damage/', 1, '', '', '_parent', 0, '2017-01-10 14:53:46', '2018-10-12 10:28:16', NULL),
(183, NULL, 178, 'Ticket Orders', 'complain', 'complain/', 1, '', '', '_parent', 0, '2017-02-04 14:01:35', '2018-10-12 10:30:20', NULL),
(221, NULL, 178, 'Service Category', 'category', 'category/', 0, '', '', '_parent', 0, '2018-09-20 08:38:17', '2018-10-12 10:27:32', NULL);
...
INSERT INTO `category` (`id`, `name`, `parent_id`, `publish`, `image`, `permalink`, `orders`, `created`, `deleted`, `updated`) VALUES
(1, 'pasang baru', 0, 1, 'casement_windows.jpg', 'pasang-baru', 2, NULL, NULL, '2018-10-05 09:52:01'),
(2, 'kerusakan', 0, 1, NULL, 'kerusakan', 1, '2018-05-24 09:39:15', NULL, '2018-10-05 09:56:33');
...
INSERT INTO `complain` (`id`, `ticketno`, `dates`, `cust_id`, `category`, `damage`, `description`, `status`, `log`, `created`, `updated`, `deleted`) VALUES
(9, '0110102007', '2018-10-10 20:07:38', '01.01.050.286', 2, 4, 'descerer', 1, '329', '2018-10-10 20:07:38', NULL, NULL);
...
CREATE TABLE `customer` (
  ...
  `No_Wilayah` varchar(100) NOT NULL,
  `No_Jalan` varchar(100) NOT NULL,
  `No_Pelanggan` varchar(100) NOT NULL,
  `Nama_Pelanggan` text NOT NULL,
  `Jenis_Pelanggan` varchar(100) NOT NULL,
  `Alamat` text NOT NULL,
  `No_Rumah` varchar(100) NOT NULL,
  `Tanggal_Pasang` varchar(100) DEFAULT NULL,
  `BA_Pasang` varchar(100) NOT NULL,
  `No_Meter` varchar(100) NOT NULL,
  `Merk_Meter` varchar(100) NOT NULL,
  `Type_Meter` varchar(100) NOT NULL,
  `Status_Pelanggan` varchar(100) NOT NULL,
  `Tempat_Bayar` varchar(100) NOT NULL,
  `Uang_Jamin` decimal(9,0) NOT NULL,
  `Beban_Denda` decimal(9,0) NOT NULL,
  `Jml_Tunggakan` decimal(10,0) NOT NULL,
  `Awal_Tunggakan` varchar(100) DEFAULT NULL,
  `Tgl_Service` datetime DEFAULT NULL,
  `Jml_Service` decimal(10,0) NOT NULL,
  `Jml_Ganti_Meter` decimal(10,0) NOT NULL,
  `Rata_Rata` varchar(100) NOT NULL,
  `Stand_Bulan_Lalu` varchar(100) NOT NULL,
  `Stand_Akhir` varchar(100) NOT NULL,
  `Kd_Buku` varchar(100) NOT NULL,
  `Ket` text,
  `Kd_Sampah` varchar(100) NOT NULL,
  `Kd_Saluran` varchar(100) NOT NULL,
  `ID_Pelanggan` varchar(100) NOT NULL,
  `Kondisi_M` varchar(100) NOT NULL,
  `Kolektif` varchar(100) DEFAULT NULL,
...
INSERT INTO `customer` (`No_Cabang`, `No_Wilayah`, `No_Jalan`, `No_Pelanggan`, `Nama_Pelanggan`, `Jenis_Pelanggan`, `Alamat`, `No_Rumah`, `Tanggal_Pasang`, `BA_Pasang`, `No_Meter`, `Merk_Meter`, `Type_Meter`, `Status_Pelanggan`, `Tempat_Bayar`, `Uang_Jamin`, `Beban_Denda`, `Jml_Tunggakan`, `Awal_Tunggakan`, `Tgl_Service`, `Jml_Service`, `Jml_Ganti_Meter`, `Rata_Rata`, `Stand_Bulan_Lalu`, `Stand_Akhir`, `Kd_Buku`, `Ket`, `Kd_Sampah`, `Kd_Saluran`, `ID_Pelanggan`, `Kondisi_M`, `Kolektif`, `letak`) VALUES
('1', '1', '10', '3776', 'A. BASAR SIREGAR', 'RU1', 'JLN. PT. ANGGI', '2', '4/1/1978 0:00', '-', '22752', 'IT', '1', '2', '3C', '0', '1', '8', NULL, NULL, '0', '0', '17', '0', '629', '22A1', '-', 'U2', '-', '01.01.010.011', 'B', NULL, NULL),
('1', '1', '20', '26129', 'MARLINA Br.SARAGIH', 'RT2', 'JLN. GANG DAME', '23', '4/1/1978 0:00', '-', '330767', 'IT', '1', '7', '3C', '0', '1', '0', NULL, '0000-00-00 00:00:00', '0', '0', '26', '0', '810', '22A1', 'ttp 20/08/2018 st 810', 'W2', '-', '01.01.020.122', 'B', NULL, NULL),
('1', '1', '30', '30447', 'M. SIRAIT', 'RT2', 'JLN. GANG SETIA', '-', '4/1/1978 0:00', '-', '523665', 'IT', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '21', '0', '1516', '22B', '-', 'W2', '-', '01.01.030.068', 'B', NULL, NULL),
('1', '1', '30', '32004', 'M. SIMATUPANG  ', 'RT3', 'JLN. GANG SETIA', '22 A', '4/1/1978 0:00', '-', '57941', 'BR', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '12', '0', '1278', '22C1', '-', 'W2', '-', '01.01.030.244', 'B', NULL, NULL),
('1', '1', '40', '19499', 'HORMAT SEMBIRING', 'RU2', 'JLN. A. YANI', '228 A', '4/1/1978 0:00', '-', '120707808', 'LF', '1', '2', '3C', '0', '1', '3', NULL, NULL, '0', '0', '8', '0', '82', '22B', '-', 'U2', '-', '01.01.040.235', 'B', NULL, NULL),
('1', '1', '40', '10652', 'JUMANTU PASARIBU', 'RT3', 'JLN. A. YANI', '306', '4/1/1978 0:00', '-', '193297', 'IT', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '2', '0', '200', '22B', '-', 'U2', '-', '01.01.040.517', 'B', NULL, NULL),
('1', '1', '40', '14151', 'B. RUSMAN MARPAUNG', 'RT3', 'JLN. A. YANI', '386', '4/1/1978 0:00', '-', '523846', 'IT', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '10', '0', '874', '22B', 'M. STOPKRAN /KOPLING BOCOR', 'U2', '-', '01.01.040.737', 'B', NULL, NULL),
('1', '1', '28', '2755', 'M. PANJAITAN', 'RT3', 'JLN. A YANI', '-', '4/1/1978 0:00', '-', '16028398', 'LF', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '15', '0', '344', '22A1', '-', 'U2', '-', '01.01.028.077', 'B', NULL, NULL),
('1', '1', '25', '17605', 'M. BUTARBUTAR 2', 'RT3', 'JLN. KS TUBUN', '-', '4/1/1978 0:00', '-', '330707', 'IT', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '7', '0', '417', '22A1', '-', 'U2', '-', '01.01.025.198', 'B', NULL, NULL),
('1', '1', '40', '32387', 'P. SIAHAAN', 'RT2', 'JLN.  JALAN AHMAD YANI', '-', '12/4/1996 0:00', '-', '15054886', 'LF', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '18', '0', '649', '22B', '-', 'V2', '-', '01.01.040.487', 'B', NULL, NULL),
('1', '1', '50', '7892', 'POTAR SIRAIT', 'RT3', 'JLN. SEJAHTERA', '9', '4/1/1978 0:00', '-', '398711', 'BR', '1', '2', '3C', '0', '1', '3', NULL, NULL, '0', '0', '1', '0', '1234', '22C2', 'opul.734.cicil 40m3.', 'V2', '-', '01.01.050.049', 'B', NULL, NULL),
('1', '1', '50', '20904', 'ISMAIL SIDABUTAR', 'RT3', 'JLN. SEJAHTERA', '69', '4/1/1978 0:00', '-', '361887', 'BR', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '8', '0', '1776', '22C1', '-', 'V2', '-', '01.01.050.170', 'B', NULL, NULL),
('1', '1', '50', '39863', 'PAIAN SIBARANI  ', 'RT3', 'JLN. SEJAHTERA', '-', '11/27/1999 0:00', '-', '162036', 'IT', '1', '2', '3C', '0', '1', '1', NULL, NULL, '0', '0', '16', '0', '695', '22C1', '-', 'V2', '-', '01.01.050.286', 'B', NULL, NULL),
('1', '1', '50', '42513', 'B. SIDAURUK', 'RT3', 'JLN. SEJAHTERA', '-', '10/4/2001 0:00', '-', '682616', 'BR', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '11', '0', '186', '22C1', '-', 'V2', '-', '01.01.050.375', 'B', 'Dauruk', NULL),
('1', '1', '50', '28930', 'RUBANUS SINAGA', 'RT3', 'JLN. SEJAHTERA', '118', '4/1/1978 0:00', '-', '782791', 'BR', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '10', '0', '163', '22C2', '-', 'V2', '-', '01.01.050.495', 'B', NULL, NULL),
('1', '1', '50', '29542', 'SIHOL P. SINAGA', 'RT3', 'JLN. SEJAHTERA', '56', '4/1/1978 0:00', '-', '785593', 'BR', '1', '2', '3C', '0', '1', '5', NULL, NULL, '0', '0', '17', '0', '354', '22C2', '-', 'V2', '-', '01.01.050.616', 'B', NULL, NULL),
('1', '1', '60', '22129', 'RUSLIANA Br.SIAHAAN', 'RT3', 'JLN. MAKMUR', '1', '4/1/1978 0:00', '-', '161951', 'IT', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '20', '0', '1604', '22D1', 'sisa cicilan 10 m', 'V2', '-', '01.01.060.005', 'B', NULL, NULL),
('1', '1', '60', '18739', 'SOSTER MANURUNG', 'RT3', 'JLN. MAKMUR', '67', '4/1/1978 0:00', '-', '502121', 'BR', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '24', '0', '637', '22D1', '-', 'V2', '-', '01.01.060.133', 'B', 'Br.Manik', NULL),
('1', '1', '60', '12721', 'B. SINAGA', 'RT3', 'JLN. MAKMUR', '127', '4/1/1978 0:00', '-', '161613', 'IT', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '5', '0', '496', '22D1', '-', 'V2', '-', '01.01.060.259', 'B', NULL, NULL),
('1', '1', '60', '24418', 'Op. MANGARA Br.TAMPUBOLON', 'RU1', 'JLN. MAKMUR', '187', '4/1/1978 0:00', '-', '623640', 'BR', '1', '2', '3C', '0', '1', '0', NULL, NULL, '0', '0', '20', '0', '547', '22D1', '-', 'V2', '-', '01.01.060.390', 'B', 'Mangisi', NULL);
...
INSERT INTO `damage` (`id`, `dates`, `due`, `category`, `description`, `address`, `coordinate`, `status`, `approved`, `staff`, `log`, `created`, `updated`, `deleted`) VALUES
(7, '2018-10-23 08:26:00', NULL, 2, 'Pecah Pispot', 'Jalan Bunga Rampai', '0,0', 0, 0, NULL, '329', '2018-10-10 18:34:17', NULL, NULL),
(4, '2018-10-08 12:00:00', '2018-10-31 12:00:00', 2, 'Pecah PIpsa', 'Jl. Rajawali No.100 B, Sipinggol-Pinggol, Siantar Bar., Kota Pematang Siantar, Sumatera Utara 21116, Indonesia', '2.947421511088548,99.04937666209253', 0, 1, 'andri', '306', '2018-10-08 11:10:50', '2018-10-08 14:37:05', NULL),
(6, '2018-10-10 12:00:00', NULL, 2, 'Kerusakan Keran Pecah', 'Jalan Agdul', '0', 0, 0, NULL, '329', '2018-10-10 18:30:02', '2018-10-10 20:09:13', NULL);
...
(235, 1, '2018-10-04', '09:23:56', 0, 'login', '', NULL, NULL, NULL),
(236, 1, '2018-10-04', '10:24:08', 40, 'update', '', NULL, NULL, NULL),
(237, 1, '2018-10-04', '10:24:21', 40, 'update', '', NULL, NULL, NULL),
(238, 1, '2018-10-04', '10:24:32', 40, 'update', '', NULL, NULL, NULL),
(239, 1, '2018-10-04', '10:25:11', 40, 'update', '', NULL, NULL, NULL),
(240, 1, '2018-10-04', '10:29:33', 0, 'logout', '', NULL, NULL, NULL),
(241, 1, '2018-10-04', '10:29:53', 0, 'login', '', NULL, NULL, NULL),
(242, 1, '2018-10-04', '10:46:14', 0, 'forced_delete', '', NULL, NULL, NULL),
(243, 1, '2018-10-04', '10:46:17', 0, 'forced_delete', '', NULL, NULL, NULL),
(244, 1, '2018-10-04', '10:46:39', 0, 'forced_delete', '', NULL, NULL, NULL),
(245, 1, '2018-10-04', '10:46:43', 0, 'forced_delete', '', NULL, NULL, NULL),
(246, 1, '2018-10-04', '10:47:02', 0, 'forced_delete', '', NULL, NULL, NULL),
(247, 1, '2018-10-04', '10:47:05', 0, 'forced_delete', '', NULL, NULL, NULL),
(248, 1, '2018-10-04', '10:47:08', 0, 'forced_delete', '', NULL, NULL, NULL),
(249, 1, '2018-10-04', '10:48:18', 0, 'forced_delete', '', NULL, NULL, NULL),
(250, 1, '2018-10-04', '10:48:18', 0, 'forced_delete', '', NULL, NULL, NULL),
(251, 1, '2018-10-04', '10:48:18', 0, 'forced_delete', '', NULL, NULL, NULL),
(252, 1, '2018-10-04', '10:48:18', 0, 'forced_delete', '', NULL, NULL, NULL),
(253, 1, '2018-10-04', '10:48:18', 0, 'forced_delete', '', NULL, NULL, NULL),
(254, 1, '2018-10-04', '10:48:29', 0, 'forced_delete', '', NULL, NULL, NULL),
(255, 1, '2018-10-04', '10:48:29', 0, 'forced_delete', '', NULL, NULL, NULL),
(256, 1, '2018-10-04', '10:48:29', 0, 'forced_delete', '', NULL, NULL, NULL),
(257, 1, '2018-10-04', '10:49:11', 0, 'forced_delete', '', NULL, NULL, NULL),
(258, 1, '2018-10-04', '10:49:11', 0, 'forced_delete', '', NULL, NULL, NULL),
(259, 1, '2018-10-04', '10:49:11', 0, 'forced_delete', '', NULL, NULL, NULL),
(260, 1, '2018-10-04', '10:49:11', 0, 'forced_delete', '', NULL, NULL, NULL),
(261, 1, '2018-10-04', '10:49:31', 0, 'forced_delete', '', NULL, NULL, NULL),
(262, 1, '2018-10-04', '10:57:34', 132, 'forced_delete', '', NULL, NULL, NULL),
(263, 1, '2018-10-04', '10:57:46', 132, 'forced_delete', '', NULL, NULL, NULL),
(264, 1, '2018-10-04', '10:58:02', 132, 'forced_delete', '', NULL, NULL, NULL),
(265, 1, '2018-10-04', '11:04:15', 132, 'update', '', NULL, NULL, NULL),
(266, 1, '2018-10-04', '11:06:09', 132, 'update', '', NULL, NULL, NULL),
(267, 1, '2018-10-05', '08:49:00', 0, 'login', '', NULL, NULL, NULL),
(268, 1, '2018-10-05', '08:56:14', 0, 'create', '', NULL, NULL, NULL),
(269, 1, '2018-10-05', '08:58:12', 132, 'forced_delete', '', NULL, NULL, NULL),
(270, 1, '2018-10-05', '08:58:25', 132, 'forced_delete', '', NULL, NULL, NULL),
(271, 1, '2018-10-05', '08:58:34', 132, 'forced_delete', '', NULL, NULL, NULL),
(272, 1, '2018-10-05', '08:58:44', 132, 'forced_delete', '', NULL, NULL, NULL),
(273, 1, '2018-10-05', '08:58:53', 132, 'forced_delete', '', NULL, NULL, NULL),
(274, 1, '2018-10-05', '08:59:03', 132, 'forced_delete', '', NULL, NULL, NULL),
(275, 1, '2018-10-05', '08:59:48', 132, 'update', '', NULL, NULL, NULL),
(276, 1, '2018-10-05', '09:51:00', 204, 'delete', '', NULL, NULL, NULL),
(277, 1, '2018-10-05', '09:51:03', 204, 'delete', '', NULL, NULL, NULL),
(278, 1, '2018-10-05', '09:51:47', 204, 'update', '', NULL, NULL, NULL),
(279, 1, '2018-10-05', '09:51:48', 204, 'update', '', NULL, NULL, NULL),
(280, 1, '2018-10-05', '09:52:01', 204, 'update', '', NULL, NULL, NULL),
(281, 1, '2018-10-05', '09:56:29', 204, 'update', '', NULL, NULL, NULL),
(282, 1, '2018-10-05', '09:56:33', 204, 'update', '', NULL, NULL, NULL),
(283, 1, '2018-10-05', '10:52:11', 0, 'create', '', NULL, NULL, NULL),
(284, 1, '2018-10-05', '14:27:33', 0, 'login', '', NULL, NULL, NULL),
(285, 1, '2018-10-05', '16:30:21', 205, 'update', '', NULL, NULL, NULL),
(286, 1, '2018-10-05', '16:38:17', 205, 'update', '', NULL, NULL, NULL),
(287, 1, '2018-10-05', '17:33:07', 205, 'create', '', NULL, NULL, NULL),
(288, 1, '2018-10-05', '17:37:46', 205, 'create', '', NULL, NULL, NULL),
(289, 1, '2018-10-05', '18:45:08', 0, 'login', '', NULL, NULL, NULL),
(290, 1, '2018-10-05', '23:05:52', 0, 'login', '', NULL, NULL, NULL),
(291, 1, '2018-10-05', '23:10:06', 205, 'update', '', NULL, NULL, NULL),
(292, 1, '2018-10-05', '23:10:20', 205, 'update', '', NULL, NULL, NULL),
(293, 1, '2018-10-05', '23:10:35', 205, 'update', '', NULL, NULL, NULL),
(294, 1, '2018-10-05', '23:11:47', 205, 'update', '', NULL, NULL, NULL),
(295, 1, '2018-10-05', '23:12:13', 205, 'update', '', NULL, NULL, NULL),
(296, 1, '2018-10-05', '23:12:21', 205, 'update', '', NULL, NULL, NULL),
(297, 1, '2018-10-05', '23:18:57', 205, 'update', '', NULL, NULL, NULL),
(298, 1, '2018-10-05', '23:19:16', 205, 'update', '', NULL, NULL, NULL),
(299, 1, '2018-10-05', '23:20:52', 205, 'update', '', NULL, NULL, NULL),
(300, 1, '2018-10-05', '23:21:31', 205, 'update', '', NULL, NULL, NULL),
(301, 1, '2018-10-05', '23:24:49', 205, 'update', '', NULL, NULL, NULL),
(302, 1, '2018-10-05', '23:24:57', 205, 'update', '', NULL, NULL, NULL),
(303, 1, '2018-10-06', '19:42:18', 0, 'login', '', NULL, NULL, NULL),
(304, 1, '2018-10-07', '07:49:48', 0, 'login', '', NULL, NULL, NULL),
(305, 1, '2018-10-07', '08:03:55', 205, 'update', '', NULL, NULL, NULL),
(306, 1, '2018-10-08', '09:31:10', 0, 'login', '', NULL, NULL, NULL),
(307, 1, '2018-10-08', '10:36:45', 0, 'login', '', NULL, NULL, NULL),
(308, 1, '2018-10-08', '11:10:50', 205, 'create', '', NULL, NULL, NULL),
(309, 1, '2018-10-08', '11:10:58', 205, 'update', '', NULL, NULL, NULL),
(310, 1, '2018-10-08', '11:11:42', 205, 'update', '', NULL, NULL, NULL),
(311, 1, '2018-10-08', '11:11:51', 205, 'update', '', NULL, NULL, NULL),
(312, 1, '2018-10-08', '11:36:38', 205, 'update', '', NULL, NULL, NULL),
(313, 1, '2018-10-08', '11:37:10', 205, 'update', '', NULL, NULL, NULL),
(314, 1, '2018-10-08', '11:37:26', 205, 'update', '', NULL, NULL, NULL),
(315, 1, '2018-10-08', '11:54:44', 205, 'create', '', NULL, NULL, NULL),
(316, 1, '2018-10-08', '11:56:06', 205, 'update', '', NULL, NULL, NULL),
(317, 1, '2018-10-08', '11:56:38', 205, 'update', '', NULL, NULL, NULL),
(318, 1, '2018-10-08', '14:33:21', 205, 'update', '', NULL, NULL, NULL),
(319, 1, '2018-10-08', '14:33:54', 205, 'update', '', NULL, NULL, NULL),
(320, 1, '2018-10-08', '14:33:56', 205, 'update', '', NULL, NULL, NULL),
(321, 1, '2018-10-08', '14:34:04', 205, 'update', '', NULL, NULL, NULL),
(322, 1, '2018-10-08', '14:37:04', 205, 'update', '', NULL, NULL, NULL),
(323, 1, '2018-10-08', '14:37:05', 205, 'update', '', NULL, NULL, NULL),
(324, 1, '2018-10-08', '18:30:38', 0, 'login', '', NULL, NULL, NULL),
(325, 1, '2018-10-09', '10:16:02', 0, 'login', '', NULL, NULL, NULL),
(326, 1, '2018-10-09', '15:49:38', 0, 'login', '', NULL, NULL, NULL),
(327, 1, '2018-10-09', '16:13:20', 0, 'create', '', NULL, NULL, NULL),
(328, 1, '2018-10-10', '09:29:36', 0, 'login', '', NULL, NULL, NULL),
(329, 1, '2018-10-10', '09:54:28', 206, 'delete', '', NULL, NULL, NULL),
(330, 1, '2018-10-10', '17:37:37', 0, 'login', '', NULL, NULL, NULL),
(331, 1, '2018-10-10', '18:30:02', 205, 'create', '', NULL, NULL, NULL),
(332, 1, '2018-10-10', '18:34:17', 205, 'create', '', NULL, NULL, NULL),
(333, 1, '2018-10-10', '19:08:13', 206, 'create', '', NULL, NULL, NULL),
(334, 1, '2018-10-10', '19:09:15', 206, 'create', '', NULL, NULL, NULL),
(335, 1, '2018-10-10', '19:11:51', 206, 'create', '', NULL, NULL, NULL),
(336, 1, '2018-10-10', '19:12:26', 206, 'create', '', NULL, NULL, NULL),
(337, 1, '2018-10-10', '19:13:18', 206, 'create', '', NULL, NULL, NULL),
(338, 1, '2018-10-10', '19:14:19', 206, 'create', '', NULL, NULL, NULL),
(339, 1, '2018-10-10', '19:37:10', 206, 'delete', '', NULL, NULL, NULL),
(340, 1, '2018-10-10', '19:37:37', 206, 'create', '', NULL, NULL, NULL),
(341, 1, '2018-10-10', '19:39:10', 206, 'delete', '', NULL, NULL, NULL),
(342, 1, '2018-10-10', '20:07:38', 206, 'create', '', NULL, NULL, NULL),
(343, 1, '2018-10-10', '20:08:57', 205, 'update', '', NULL, NULL, NULL),
(344, 1, '2018-10-10', '20:09:13', 205, 'update', '', NULL, NULL, NULL),
(345, 1, '2018-10-11', '14:41:38', 0, 'login', '', NULL, NULL, NULL),
(346, 1, '2018-10-12', '09:45:15', 0, 'login', '', NULL, NULL, NULL),
(347, 1, '2018-10-12', '10:27:32', 132, 'update', '', NULL, NULL, NULL),
(348, 1, '2018-10-12', '10:28:16', 132, 'update', '', NULL, NULL, NULL),
(349, 1, '2018-10-12', '10:29:51', 0, 'update', '', NULL, NULL, NULL),
(350, 1, '2018-10-12', '10:30:20', 132, 'update', '', NULL, NULL, NULL),
(351, 1, '2018-10-12', '10:30:36', 132, 'forced_delete', '', NULL, NULL, NULL),
(352, 1, '2018-10-12', '10:30:43', 132, 'forced_delete', '', NULL, NULL, NULL),
(353, 1, '2018-10-12', '10:30:52', 132, 'forced_delete', '', NULL, NULL, NULL),
(354, 1, '2018-10-14', '14:09:55', 0, 'login', '', NULL, NULL, NULL),
(355, 1, '2018-10-14', '14:13:35', 0, 'logout', '', NULL, NULL, NULL),
(356, 1, '2018-10-14', '14:18:31', 0, 'login', '', NULL, NULL, NULL),
(357, 1, '2018-10-14', '21:33:34', 0, 'login', '', NULL, NULL, NULL),
(358, 1, '2018-10-17', '18:38:47', 0, 'login', '', NULL, NULL, NULL);
...
(204, 'category', 'Service Category', 100, 'Y', 'admin', 'Y', 'officer,admin', 'default.png', 1, 0, 'category', '2018-10-05 08:56:14', NULL, NULL),
(205, 'damage', 'Damage Type', 200, 'N', 'admin', 'Y', 'officer,admin', 'default.png', 0, 0, 'damage', '2018-10-05 10:52:11', NULL, NULL),
(206, 'complain', 'Ticket Support', 1000, 'Y', 'admin', 'Y', 'officer,admin', 'default.png', 0, 0, 'complain', '2018-10-09 16:13:20', '2018-10-12 10:29:51', NULL);
...
(1, 'PDAM TIRTAULI', 'Jl. Besar Panettongah, Naga Huta, Siantar Marimbun\n', '0624-0000000', '0-0', '061-4522712', 'info@pdamtirtauli.com', 'info@pdamtirtauli.com', 'info@pdamtirtauli.com', 'info@pdamtirtauli.com', 21129, 'Pematang Siantar', 'PDAM TIRTAULI', '105-000-000000-0', 'Unknow', 'www.pdamtirtauli.com', 'logo.png', 'PDAM TIRTAULI', 'PDAM TIRTAULI', 'Manager', 'Accounting', '', NULL, '2018-10-04 10:25:11', NULL);
...
(14, 'dodol', '12345', 'dodol', 'desc', '08170114222', '', '1111', 'dodol@yahoo.vom', NULL, 'officer', 1, '', 2, '2018-09-21 17:57:14', NULL, NULL);
...
(12, 'dodol@yahoo.com', '$2y$10$1LCLzkO4cB19Hobs1UES9eXMrFEnsFS2SV.a8hDjPmpmPz1gtvxUu', '2018-10-02 06:56:54', NULL),
(9, 'dodi@yahoo.com', '$2y$10$bXUDbW6E2XIAMTFzw4AyZO0sENsJiJwa2ZIxJtzXN8MkT0rNhFOXa', '2018-10-02 05:48:28', NULL),
(8, 'dodi@yahoo.com', '$2y$10$D/OiIf/HHf4vELebpJLMR.dZBQSSZxHkI5.nJ89P7yTfAeb.Ku/hC', '2018-10-02 05:48:27', NULL),
(11, 'dodol@yahoo.com', '$2y$10$25aJ9KUdGWuFKxm6BsiNpeKBvfkMaWdOAi1EyECZj9YBKlrKew3rW', '2018-10-02 06:42:33', NULL),
(10, 'dodol@yahoo.com', '$2y$10$Ldjoxp4KUcCZo0RG15Pc6eg8C5g6haNjx2ur2hZjKCUiEWU4gBrr6', '2018-10-02 06:42:26', NULL),
(13, 'dodol@yahoo.com', '$2y$10$5AL/Ak0lAevdKIbXoULjXOODz34dHzeIa6gZnT9Yb3AkCdqcAEWEu', '2018-10-02 06:57:07', NULL),
(14, 'dodol@yahoo.com', '$2y$10$LHT.ficX2CykJDkUUOo18Og4T3DH69Acz1TTHP.hsuOK3X30K2uki', '2018-10-02 06:57:18', NULL);
